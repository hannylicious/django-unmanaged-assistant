"""Venv unmanaged models single database."""
...
class VenvUnmanagedModelNC(models.Model):
...
class VenvUnmanagedModelDottedTableNC(models.Model):
...
class VenvUnmanagedSchemaModel(models.Model):
...
class VenvUnmanagedModel(models.Model):
...
class VenvUnmanagedModelDottedTable(models.Model):
